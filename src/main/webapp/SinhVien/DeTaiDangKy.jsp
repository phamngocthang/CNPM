		                ...
		                <tbody>
								...
								<c:if test="${state == true}">
									<tr>
			                            ...
			                            <c:set var="d" value="${result.detai}" />
			                            <td><span class="caret"></span>${d.tenDeTai}</td>
			                            <td>${infor.fullName}</td>
			                                <td><a class="badge red">${amount}</a> / <a class="badge green">2</a></td>
			                                <td>
			                                <a href="ChiTietDeTai?id=${d.idDeTai}" class="btn btn-success btn-xs" style="background-color: transparent; border-color: transparent;">
			                                ...
			                                <a href="XoaDangKy?id=${result.idDangKy}" class="btn btn-success btn-xs" style="background-color: transparent; border-color: transparent;">

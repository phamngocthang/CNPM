                        ...
                        <div class="col-md-3">
                            ...
                            <div id="desktop-menu">
                                <div class="panel panel-default">
                                    ...
                                    <a href="LoadLoaiDeTai" class="list-group-item "><img src="Content/public/images/Actions-view-calendar-list-icon.png" width="24" height="24" /><span class="pull-right"><i class="icon-chevron-right"></i></span> Danh sách đề tài</a>
                                    <c:if test="${userLogged.loaiTaiKhoan == 2}">
                                    	<a href="DTDangKyGV" class="list-group-item "><img src="Content/public/images/Actions-help-contents-icon.png" width="24" height="24" /><span class="pull-right"><i class="icon-chevron-right"></i></span> Đề Tài Đăng Ký</a>
                                    </c:if>

			    ...
			    <div class="panel-body">
			        <div id="search">
			            <select id="search_cn" class="form-control text-center" onchange="changeFunc();">
			                <option value="${pageContext.request.contextPath}/DanhSachDeTai?index=1&cn=-1" ${tagcn==-1 ? "selected": ""}>Tất cả chuyên ngành</option>
			                <option value="${pageContext.request.contextPath}/DanhSachDeTai?index=1&cn=1" ${tagcn==1 ? "selected": ""}>Công nghệ phần mềm</option>
			                <option value="${pageContext.request.contextPath}/DanhSachDeTai?index=1&cn=2" ${tagcn==2 ? "selected" : ""}>Hệ thống thống tin</option>
			                <option value="${pageContext.request.contextPath}/DanhSachDeTai?index=1&cn=3" ${tagcn==3 ? "selected" : ""}>Mạng máy tính</option>
			            </select>

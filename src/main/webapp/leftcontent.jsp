                        ...
                        <div class="col-md-3">
                            ...
                            <div id="desktop-menu">
                                <div class="panel panel-default">
                                    ...
                                    <a href="DanhSachDeTai?index=1&cn=-1" class="list-group-item "><img src="Content/public/images/Actions-view-calendar-list-icon.png" width="24" height="24" /><span class="pull-right"><i class="icon-chevron-right"></i></span> Danh sách đề tài</a>

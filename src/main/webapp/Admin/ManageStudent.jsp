...
<body>
 <!-- Add Form -->
  ...
  <main class='grid grid-cols-[200px_1fr] p-4 min-h-screen gap-4 max-w-[1200px] mx-auto pt-10'>
    ...
    <article>
      <div class='pb-4'>
        <h1 class='uppercase text-2xl font-semibold text-center p-4'>Quản Lý Sinh Viên</h1>

        <button onclick="openAddForm()"
          class='bg-blue-500 hover:bg-blue-400 text-center text-white p-2 mb-2 rounded-md shadow-md'>Thêm Sinh Viên Mới</button>
        <button class='bg-blue-500 hover:bg-blue-400 text-center text-white p-2 mb-2 rounded-md shadow-md'><a href = "/DangKyDeTai/UpdateInforStudentAdmin">Cập Nhật Thông tin Sinh Viên</a></button>
        <table class='bg-gray-200 table-auto w-full shadow-md border-b-2 border-yellow-500'>
          <thead class='bg-yellow-500'>
            <tr>
              <th class='p-2 text-white'>Tên Sinh Viên</th>
          ...
          <tbody>
		        ...
		        <tr class='bg-gray-100 odd:bg-gray-200' style='background-color: ;'>
	              ...
	              <td>
	              <a href = "/DangKyDeTai/ManageStudent?type=delete&username=${rs.getInforaccount().getUserName()}">

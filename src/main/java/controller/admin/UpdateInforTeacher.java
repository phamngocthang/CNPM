...
@WebServlet(name = "UpdateInforTeacher", urlPatterns = {"/UpdateInforTeacherAdmin"})
public class UpdateInforTeacher extends HttpServlet{
	@Override
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		request.setAttribute("allchuyennganh", daoChuyenNganh.getAll());
 		request.getRequestDispatcher("Admin/UpdateInforTeacher.jsp").forward(request, response);
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
    	...
    	request.getRequestDispatcher("Admin/ManageTeacher.jsp").forward(request, response);
    }
}

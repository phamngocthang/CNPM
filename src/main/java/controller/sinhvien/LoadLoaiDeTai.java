...
@WebServlet(name = "LoadLoaiDeTai", urlPatterns = {"/LoadLoaiDeTai"})
public class LoadLoaiDeTai extends HttpServlet {
	...
	protected void processRequest(HttpServletRequest request, HttpServletResponse response)
		...
		request.getRequestDispatcher("SinhVien/LoaiDeTai.jsp").forward(request, response);
    }
